export const TERMS_BOX = [
  {
    id: 1,
    subject: '(필수) 이용약관 동의',
    content: `제1조(목적) \n\n이 약관은 주식회사 wePet(이하 “회사”라 한다)이 운영하는 wePet 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 사이버몰과 “이용자”의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.\n\n제2조(정의)\n\n① "몰"이란 “회사”가 재화 또는 용역을 “이용자”에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 또는 용역을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
2. 휴대폰 결제
3. "몰"과 계약을 맺었거나 "몰"이 인정한 상품권에 의한 결제
...
\n② “회원”의 구매활동, 이벤트 참여 등에 따라 “몰”이 무료로 부여하는 쿠폰(이하 “무료 쿠폰”이라 한다)은 현금 환급이 불가하며, “회원” 탈퇴 시 미 사용한 “무료 쿠폰”은 소멸됩니다. “몰”은 소멸되는 “무료 쿠폰”에 대해서 별도의 보상을 하지 않습니다.
\n제15조(청약철회 등)
...
\n부칙
\n1. 이 약관은 2022년 3월 14일부터 적용됩니다.`,
  },
  {
    id: 2,
    subject: '(필수) 개인정보 수집 및 이용 동의',
    content: `(주)wePet(이하 ‘회사’)은 원활한 서비스 제공을 위해 최소한의 범위 내에서 아래와 같이 개인정보를 수집 이용합니다.
    \n1. 수집 이용 항목
    \n(1) 회사는 회원 가입 시 아이디, 비밀번호, 이름, 휴대전화번호, 이메일 주소, 주소, (선택)생년월일을 수집 이용합니다.
    \n(2) 서비스 이용과정에서 아래 정보가 자동 생성되어 수집, 저장, 조합, 분석될 수 있습니다.\n- 쿠키, 방문기록, 서비스 이용기록, 기기정보(기기고유번호, OS, 버전, 모델명 등)
    \n2. 수집 이용 목적
    \n(1) 회사는 서비스 제공을 위하여 수집한 모든 개인정보와 생성정보를 아래의 목적으로 이용합니다.
    \n- 회원제 서비스 제공, 회원 식별, 휴대폰 본인인증, 회원관리\n- 서비스 제공, 서비스 개선, 신규 서비스 개발, 맞춤 서비스 제공\n- 주문 및 배송서비스 제공\n- 문의 상담 및 불만 처리\n- 불법 및 부정이용 방지(부정거래 기록 확인)\n- 서비스 방문 및 이용기록 통계 및 분석\n- 서비스 만족도 조사 및 관리\n- 고지사항 전달
    \n3. 보유 및 이용 기간
    \n(1) 수집한 개인정보는 회원 탈퇴 시 즉시 파기합니다.
    \n(2) 관련 법령에 따라 회원탈퇴 이후에도 보관해야하는 경우에는 법령에서 정한 보관기간을 따릅니다.\n개인정보 수집 이용에 동의하지 않으실 수 있으며, 동의하지 않는 경우 회원제 서비스 제공이 제한됩니다.\n그 밖의 개인정보 처리에 관한 사항은 개인정보 처리방침에서 확인하실 수 있습니다.`,
  },
  {
    id: 3,
    subject: '(선택) 개인정보 수집 및 이용 동의',
    content: `㈜wePet은 아래와 같이 개인정보를 수집, 이용 합니다
